...
# Train the model
history = model.fit(inputs, labels, batch_size=batch_size, epochs=epochs, class_weight='auto', validation_split=0.1, callbacks=[EarlyStopping(monitor='val_loss', patience=5, verbose=1, restore_best_weights=True)], shuffle=True, verbose=1)
