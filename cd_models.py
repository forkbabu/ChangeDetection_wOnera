...
def UNet_ConvUnit(input_tensor, stage, nb_filter, kernel_size=3, mode='None'):   
    x = FastDeconv2D(nb_filter, kernel_size,activation='selu',  kernel_initializer='he_normal', padding='same', kernel_regularizer=l2(1e-4))(input_tensor)
    x = FastDeconv2D(nb_filter, kernel_size,activation='selu',  kernel_initializer='he_normal', padding='same', kernel_regularizer=l2(1e-4))(x)
